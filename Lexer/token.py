class Token:
    ...
    def t_COMMENT(self, t):
        ...
        # Token rule to identify and ignore comments in the format <% %>, spanning multiple lines.
        # This function uses a non-greedy pattern to capture comments efficiently.

        # Parameters:
        #   LexToken: The token object generated by PLY.

        # Regular expression pattern to match comments in the format <% %>:

        r'<%(.|\n)*%>'


        # Count the number of newlines within the comment and update the lexer line number accordingly.
        # This is crucial for maintaining accurate line numbers after ignoring the comments.
        t.lexer.lineno += t.value.count('\n')

        # Since comments are ignored, return nothing, effectively telling the lexer to skip this token.
        return
